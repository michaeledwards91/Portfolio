								...
								<div className="col s12 m6">
								  <div className="card sticky-action hoverable">
								    ...
								    <div className="card-action">
								      <div className="card-title activator grey-text text-darken-4"><a href="http://yum-yumrecipes.herokuapp.com/" target="_blank">Yum-Yum Recipes</a><i className="material-icons right">more_vert</i></div>
								      <p><a className="githubLink" href="#">This is a link</a></p>
								    </div>
								    <div className="card-reveal">
								      <span className="card-title grey-text text-darken-4">Yum-Yum Recipes<i className="material-icons right">close</i></span>
